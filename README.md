...
py -m producers.json_producer_miller
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.json_producer_miller
```
...
```shell
.venv\Scripts\activate
py -m consumers.json_consumer_miller
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.json_consumer_miller
```
